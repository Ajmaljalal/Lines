...
from app.tools.html_content_generator import  html_content_generation_based_on_internet_search, html_content_generation_based_on_user_provided_string_content
from app.tools.html_content_updates import html_content_updates
from app.tools.send_email import send_email
from app.utils.llms import GROQ_LLM, OpenAI_GPT4O
...
llm_with_tools = OpenAI_GPT4O.bind_tools(
    [html_content_generation_based_on_internet_search, html_content_generation_based_on_user_provided_string_content, html_content_updates, send_email]
...
workflow.add_node("tools", ToolNode([html_content_generation_based_on_user_provided_string_content, html_content_generation_based_on_internet_search, html_content_updates, send_email]))
